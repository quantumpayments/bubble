...
var wallet1 = "https://localhost/wallet/small/wallet#this"
var wallet2 = "https://localhost/wallet/medium/wallet#this"
...
var credit3 = createCredit(source, threshold, currency, destination)

config.wallet = wallet1;
         ...
         if (res >= threshold) {
           wc.insert(credit2, sequelize, config, function(err, res) {
              if (!err) {
                ...
                wc.insert(credit3, sequelize, config, function(err, res) {
                   if (!err) {
                     console.log(res)
                   } else {
                     console.error(err)
